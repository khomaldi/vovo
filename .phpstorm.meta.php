...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\auth()->user(), map([
        '' => \App\Modules\Users\Models\User::class,
    ]));
...
'filesystems.disks.s3.report','filesystems.links./var/www/html/public/storage','json-api-paginate.max_results','json-api-paginate.default_size','json-api-paginate.number_parameter',
...
'json-api-paginate.use_fast_pagination','json-api-paginate.base_url','json-api-paginate.pagination_parameter','logging.default','logging.deprecations.channel',
...
'session.http_only','session.same_site','session.partitioned','query-builder.parameters.include','query-builder.parameters.filter',
...
'web','api',);
        registerArgumentsSet('routes', 'storage.local','scramble.docs.ui',
...
'BROADCAST_CONNECTION','FILESYSTEM_DISK','QUEUE_CONNECTION','CACHE_STORE','SESSION_DRIVER',);
